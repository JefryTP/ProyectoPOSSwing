...
public class LoginElaborado extends JFrame {
    ...
    public LoginElaborado() {
        ...
        // Campo de Texto: Código (se usa como DNI del usuario en la BD)
        ...
        btnIngresar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                // Acceso rápido de administrador, solo para pruebas mientras se
                // termina de dar de alta a los usuarios reales en la BD.
                // TODO: quitar este bloque cuando todos los usuarios ya estén
                // registrados en la tabla `usuario`.
                if (usuario.equals("admin") && password.equals("123")) {
                    Sesion.idUsuarioActual = 1; // debe existir un usuario con id=1 en la BD
                    dispose();
                ...
                // Login real: el "Código" se valida contra el dni del usuario en la BD
                Usuario u = usuarioController.login(usuario, password);
 
                if (u != null) {
                    Sesion.idUsuarioActual = u.getId();
